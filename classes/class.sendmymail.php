...
class SendMyMail extends PHPMailer{
    public function send_my_mail($email,$subject,$body){
...
//        $mail->Password   = "sOrinJK89Fahim";            // GMAIL password
      ...
      //  pc_debug("I have entered in Mail Class",__FILE__,__LINE__);
    ...
    //    $mail->SetFrom('mahbub.facebook@gmail.com', 'Mahbub Aaman');
        $mail->SetFrom('info@riseuplabs.com', 'Account Confirmations');
...
//            error_log("Subject is (3rd Time)= $subject");
        ...
        public function send_my_mail_2($subject,$body,$sendTo = null){
        error_log("SendTo = $sendTo");
