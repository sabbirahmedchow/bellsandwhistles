...
if(hash == '#order-complete')
{
  $('.cart-page-tablist ul li a[href="#order-complete"]').addClass("active");
  $('.cart-page-tablist ul li a[href="#shopping-cart"]').removeClass("active");
...
$("#btnSubmitUser").click(function()
{
 ...
 var dataString = 'name='+fullname+'&email='+ email+addstr;
 ...
 $("#confirm").html("<p style='height:100%; margin-left:100px;' align='center'><img src='img/ajax-loader.gif' width='50' height='50' border='0' align='center' /></p>");
  $.ajax({
    ...
    success: function(res) {
        ...
        $('#confirm').html("<span class=\"notification n-success\" style='color:red; margin-bottom:6px; text-align:center;'>Updated Successfully.</span>")
...
function addtoWishlist(ProdId, userId)
{
    ...
    else
    {
      ...
      var prod_id = ProdId;
        ...
        var dataString = 'user_id='+user_id+'&prod_id='+prod_id;
...
function postRating(rate, prdId)
{
    var val = window.confirm("Are you sure about your rating?"); 
    if(val == true)
    {
    //$(".form-ratting").css("display", "none");
    $(".form-ratting").html("<span>You gave "+ rate +" star rating to this product. Thanks.</span>");    
    //window. alert("sssdsd");
    
      var rate = rate;
      var prod_id = prdId;
     
        var dataString = 'rate='+rate+'&prod_id='+prod_id;
